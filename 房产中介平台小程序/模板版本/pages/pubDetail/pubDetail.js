...
Page({
      ...
      if (this.data.images.length == 0){
        ...
        app.post(strr, dats, function (res) {
          ...
          if (res.code) {
            ...
            wx.redirectTo({
              url: '/pages/detail/detail?id=' + dats.sunwouId,
            })
          }
        })
      }else{
                    ...
                    if(that.data.jkl == false){
                      app.post(strr, dats, function (res) {
                        ...
                        if (res.code) {
                          ...
                          wx.redirectTo({
                            url: '/pages/detail/detail?id=' + sss,
                          })
                        }
                      })
                    }
  ...
  bindPickerChangeCzfs(e) {
    var that = this
    var forDa = that.data.formData;
    forDa.config.czfs = that.data.czfs[e.detail.value]
    this.setData({
      czflag: e.detail.value,
      formData: forDa
    })
  },
  //朝向
